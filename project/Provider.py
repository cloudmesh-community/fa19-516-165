...
# Services to implement including vm, flavor, and image
...
yaml_path = "~/.cloudmesh/cloudmesh.yaml"

# based on  openstack and and change the corresponding dicts from
...
class Provider(ComputeNodeABC, ComputeProviderPlugin):
    ...
    @staticmethod
    def __init__(self, name='gcp', configuration=None, credentials =None):
        """
